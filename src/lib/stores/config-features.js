export const config = {
	mapTitle: 'amphetamine-consumption-europe', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-amphetamine.vercel.app/', // The url provided when deploying the map on Vercel
